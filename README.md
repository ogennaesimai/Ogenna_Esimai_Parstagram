# Project 3 - Ogenna_Esimai_Parstagram
...
- [x] The user should switch between different tabs - viewing all posts (feed view), compose (capture photos form camera) and profile tabs (posts made) using fragments and a Bottom Navigation View. (2 points)
- [x] User can load more posts once he or she reaches the bottom of the feed using infinite scrolling. (2 points)
- [x] User can pull down to refresh 
- [x] Several colors added for refresh Parstagram posts timeline by pull down to refresh

## Video Walkthrough - Ogenna_Esimai_Parstagram_Walkthrough_#3

Here's a walkthrough of implemented user stories:

<img src='https://github.com/ogennaesimai/Ogenna_Esimai_Parstagram/blob/master/Ogenna_Esimai_Parstagram_Walkthrough_%233.gif' title='Ogenna_Esimai_Parstagram_Walkthrough_#3' width='400' alt='Ogenna_Esimai_Parstagram_Walkthrough_#3' />
...
- [x] (partial, not creation time fully) Show the username and creation time for each post.
- [ ] User can tap a post to view post details, including timestamp and caption.
- [ ] User Profiles
      - [ ] Allow the logged in user to add a profile photo
      - [ ] Display the profile photo with each post
...
- [x] changed look and feel of StatusBar background color and text color to match Instagram’s 
- [x] changed ActionBar background color and text color and text style to match Instagram’s
- [x] changed look and feel of ToolBar background color and text color to match Instagram’s


## Video Walkthrough - Ogenna_Esimai_Parstagram_Walkthrough_#4

Here's a walkthrough of implemented user stories:

<img src='https://github.com/ogennaesimai/Ogenna_Esimai_Parstagram/blob/master/Ogenna_Esimai_Parstagram_Walkthrough_%234.gif' title='Ogenna_Esimai_Parstagram_Walkthrough_#4' width='400' alt='Ogenna_Esimai_Parstagram_Walkthrough_#4' />
