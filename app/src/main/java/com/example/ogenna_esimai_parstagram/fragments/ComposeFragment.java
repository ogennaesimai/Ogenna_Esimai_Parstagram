...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String creationTime = Post.KEY_CREATED_AT;
                //savePost(description, currentUser, photoFile);
                savePost(caption, currentUser, photoFile, creationTime);
            }
        });
    ...
    private void savePost(String caption, ParseUser currentUser, File photoFile, String creationTime) {
        Post post = new Post();
        //post.setDescription(description);
        post.setCaption(caption);
        post.setImage(new ParseFile(photoFile));
        post.setUser(currentUser);
        //post.getKeyCreatedAt(creationTime);
